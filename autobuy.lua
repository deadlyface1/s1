...
local BalenciagaList = {
    "Джинсовка Голубая 'Balenciaga'",
    "Бежевое худи 'Balenciaga'",
    "Чёрная футболка Paris 'Balenciaga'",
    "Белый Свитшот 'Balenciaga'",
    "Потрёпанные Штаны 'Balenciaga'",
    "Бежевый Свитшот TOUR 'Balenciaga'",
    "Чёрная Футболка PARIS 'Balenciaga'",
    "Белая Футболка PARIS 'Balenciaga'",
    "PROPERTY OF BALENCIAGA DESIGN TEAM PARIS 'Balenciaga'",
    "Джинсовка 'Balenciaga'",
    "Брюки 'Balenciaga'",
    "Спортивные Джоггеры 'Balenciaga'",
    "Джинсы Double Waits 'Balenciaga'",
    "Тёмные Джинсы 'Balenciaga'",
    "Красная Куртка 'Balenciaga'",
    "Чёрная Джинсовка SINNERS 'Balenciaga'",
    "Белая Футболка 'Balenciaga'",
    "Чёрная Футболка 'Balenciaga'",
...
local ChromeHeartsList = {
    ...
    "Бежевая Кофта Cemetery Cross Tire Track 'Chrome hearts'",
    "Brown Худи Horse Shoe 'Chrome hearts'",
    ...
    "Лаймовые Джинсы NYFW 'Chrome hearts'"
}
